package com.hgapp.qrbar.feature.tabs.scan
...
import com.hgapp.qrbar.feature.common.dialog.ConfirmBarcodeDialogFragment
import com.hgapp.qrbar.feature.tabs.scan.file.ScanBarcodeFromFileActivity
...
class ScanBarcodeFromCameraFragment : Fragment(), ConfirmBarcodeDialogFragment.Listener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(com.hgapp.qrbar.R.layout.fragment_scan_barcode_from_camera, container, false)
    }
    ...
    private fun restartPreviewWithDelay(showMessage: Boolean) {
        Completable
            ...
            .subscribe {
                if (showMessage) {
                    showToast(com.hgapp.qrbar.R.string.fragment_scan_barcode_from_camera_barcode_saved)
                }
                restartPreview()
            }
            .addTo(disposable)
