package com.hgapp.qrbar.feature.tabs.settings
...
import com.hgapp.qrbar.feature.tabs.settings.camera.ChooseCameraActivity
import com.hgapp.qrbar.feature.tabs.settings.formats.SupportedFormatsActivity
import com.hgapp.qrbar.feature.tabs.settings.permissions.AllPermissionsActivity
import com.hgapp.qrbar.feature.tabs.settings.search.ChooseSearchEngineActivity
import com.hgapp.qrbar.feature.tabs.settings.theme.ChooseThemeActivity
...
class SettingsFragment : Fragment(), DeleteConfirmationDialogFragment.Listener {
    ...
    private fun showAppVersion() {
        button_app_version.hint = com.hgapp.qrbar.BuildConfig.VERSION_NAME
    }
}